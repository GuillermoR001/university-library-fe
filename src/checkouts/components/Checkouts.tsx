...
import { CheckoutsList } from '../services/ChecoutsServices';
import { Checkout } from "../../interfaces/Models";
import { CheckoutReturnDate } from "./CheckoutReturnDate";
...
export const Checkouts = () => {
    ...
    const fetchCheckouts = async () => {
      try {
        const response = await CheckoutsList();
                        ...
                        checkouts.map((checkout, i) => {
                            return (
                                <tr key={i}>
                                    ...
                                    <td>{`${checkout.user.name} ${checkout.user.last_name}`}</td>
